...
<html lang="en">
  ...
  <body>
    <h3 class="text-center display-4 mt-2">Update Products</h3>
    <div class="container">
...
%>
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="pid" value="<%=rs.getInt("pid") %>">
      ...
      <div class="form-group">
    <label for="exampleInputPassword1">Product Status: 1- Enabled 2- Disabled</label>
    <input type="number" class="form-control" value="<%=rs.getInt("status") %>"name="status" maxlength="1" size="2">
